...
def train_recovery(args):
    ...
    train_dataset = TrajectoryInfillingDataset(train_data, args, max_len, drop_num=[1, 2, 3, 4],
                                             drop_ratio=[0.2,0.4,0.6,0.7], id2loc=id2loc)
    ...
    for epoch in range(args.num_epochs):
        ...
        for iteration, (batch_data, batch_cl) in enumerate(train_dataloader):
            ...
            batch_loc, batch_time,batch_time_segments, batch_coor, batch_lengths, batch_masked_pos, batch_pred_inputs, batch_pred_targets, batch_masked_weight = batch_data
            batch_cl_seqs, batch_cl_tms,batch_cl_tms_segments, batch_cl_coors, batch_cl_lengths = batch_cl
            ...
            pred = recovery_model(batch_loc, batch_time,batch_time_segments, batch_coor, attn_mask, A, 'recovery', batch_masked_pos, batch_pred_inputs)
            ...
            if epoch >= args.warm_up_epochs:
                ...
                cl_output_representations = recovery_model(batch_cl_seqs, batch_cl_tms,batch_cl_tms_segments, batch_cl_coors, attn_mask_cl, A, 'contrastive')
