...
class Transformer_tagging(nn.Module):
    ...
    def __init__(self, model_dimension, fourier_dimension, time_dimension,num_time_segments, vocab_size, number_of_heads, number_of_layers, number_cls,
        ...
        self.time_embedding_segments = nn.Embedding(num_time_segments, model_dimension)
    ...
    def forward(self, src_token_ids_batch, src_time_batch,src_time_batch_segments, src_coor_batch, src_mask, adj_graph, type):
        src_representations = self.encode(src_token_ids_batch, src_time_batch,src_time_batch_segments, src_coor_batch, src_mask, adj_graph)
    ...
    def encode(self, src_token_ids_batch, src_time_batch,src_time_batch_segments, src_dist_batch, src_mask, adj_graph):
        ...
        src_time_embeddings_batch_segments = self.time_embedding_segments(src_time_batch_segments)
        src_dist_embeddings_batch = self.dist_embedding(src_dist_batch)

        src_representations_batch = self.encoder(src_embeddings_batch, src_time_embeddings_batch, src_time_embeddings_batch_segments,
...
class Encoder(nn.Module):
    ...
    def forward(self, src_embeddings_batch, src_time_embeddings_batch,src_time_embeddings_batch_segments, src_dist_embeddings_batch, src_mask):
        src_representations_batch = src_embeddings_batch + src_time_embeddings_batch + src_time_embeddings_batch_segments + src_dist_embeddings_batch
